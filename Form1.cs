...
namespace Calculator
{
    public class Calc : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.button2, "Извлечение корня");
            ...
            this.toolTip1.SetToolTip(this.button3, "Обратное число");
            ...
            this.toolTip1.SetToolTip(this.button4, "Квадрат числа");
